    ...
    while True:
        if is_enable and is_zero:
            if action == 1:
                ...
                mc.send_angle(1, command[0], speed)
            elif action == 2:
                command[0] -= 2
                if command[0] < -285:
                    command[0] = -280
                ...
                mc.send_angle(2, command[1], speed)
            elif action == 4:
                command[1] -= 2
                if command[1] < -285:
                    command[1] = -280
                ...
                if command[2] > 450:
                    command[2] = 445
                mc.send_angle(3, command[2], speed)
            elif action == 6:
                command[2] -= 2
                if command[2] < -120:
                    command[2] = -118
                ...
                if command[3] > 285:
                    command[3] = 280
                mc.send_angle(4, command[3], speed)
            elif action == 13:
                command[3] -= 10
                if command[3] < -285:
                    command[3] = -280
                ...
                if command[4] > 285:
                    command[4] = 280
                mc.send_angle(5, command[4], speed)
            elif action == 15:
                command[4] -= 10
                if command[4] < -285:
                    command[4] = -280
                ...
                if command[5] > 450:
                    command[5] = 440
                # mc.send_angle(6, command[5], speed)
            elif action == 17:
                command[5] -= 10
                if command[5] < -120:
                    command[5] = -118
